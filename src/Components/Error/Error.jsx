...
const Error = () => {
  return (
    <section className='py-[50px] font-dm'>
        ...
        <Link to='/'>
        <button className='py-[10px] px-[30px] rounded-lg bg-primary hover:bg-transparent hover:border hove:border-[1px] hover:border-primary hover:text-primary easy-in duration-300 border border-[1px] border-primary text-white mt-[20px]'>Back To Home</button>
        </Link>
        </div>
    </section>
  )
