  ...
  return (
    <div>
      <ul className="md:text-[18px] font-dm md:flex md:justify-center md:items-center gap-[30px]">
        ...
        <li className="relative" onMouseEnter={() => setDropdownVisible(true)} onMouseLeave={() => setDropdownVisible(false)} >
          <Link  to="/shop" className={`shop ${  location.pathname === '/shop' ? 'text-primary' : 'text-secondary' } hover:text-primary font-bold duration-300 cursor-pointer`} >
          ...
          {isDropdownVisible && (
            <div className="shop_item absolute text-white text-[14px] bg-[#F5F5F3] top-[20px] w-[500px] left-[-180px] rounded-lg duration-400 z-[99] flex justify-between text-center py-[20px]">
              <div className="md:w-1/3">
                <ul className="p-[20px]">
                  <li className="py-[5px] text-[18px] text-primary font-bold duration-300">
                    <Link to="/makeup/face">Men</Link>
                  </li>
                  <li className="py-[5px] text-primary duration-300 hover:text-secondary">
                    <Link to="/makeup/lips">Lips</Link>
                  </li>
                </ul>
              </div>
              <div className="md:w-1/3 border-x-2 border-secondary">
                <ul className="p-[20px]">
                  <li className="py-[5px] text-[18px] text-primary font-bold duration-300">
                    <Link to="/makeup/face">Women</Link>
                  </li>
                  <li className="py-[5px] text-primary duration-300 hover:text-secondary">
                    <Link to="/makeup/lips">Lips</Link>
                  </li>
