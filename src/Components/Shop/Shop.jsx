  ...
  return (
    <section className='py-[50px]'>
              <div className="container">
                <h5 className='font-dm font-bold text-[40px] text-primary py-[20px]'>Shop</h5>
                  <div className="shop_main flex items-center md:justify-between justify-center gap-[25px] md:gap-0 flex-wrap">
                  <div>
