    ...
    <header className='bg-[#F5F5F3] md:py-[25px] py-[14px]'>
        <div className="container">
            <div className="header_main flex justify-between items-center">
                ...
                <div className='w-[80%] md:w-[60%] md:flex md:justify-center md:items-center gap-[20px] md:gap-0 relative'>
                ...
                <div className='md:w-[20%] md:flex justify-end items-center gap-[10px] hidden '>
